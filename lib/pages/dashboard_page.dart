  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
          padding: const EdgeInsets.only(left: 16.0), // Atur jarak kiri
          child: Image.asset('assets/logo/pajakpro-logo-nobg.png'),
        ),
        centerTitle: true,
        title: const Text(
          "PAJAK PRO",
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                ButtonMenuDashboard(
                  imagePath:
                      'assets/icons/pajak-penjualan-atas-barang-mewah.png',
